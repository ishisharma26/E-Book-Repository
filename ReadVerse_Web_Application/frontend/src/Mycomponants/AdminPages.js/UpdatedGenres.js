...
const UpdateGenres = () => {
  ...
  const HendleSubmit=(e)=>{
    ...
    axios.put(`http://localhost:5000/admin/updateGenre/${id}`,{name})
    .then((result)=>{
       if(result.data.message==="Genre SuccessFully Updated"){
        ...
        <form >
          <UserDetails>
            <InputBox style={{width:"100%"}}>
              ...
              <Input type="text" placeholder="Enter tital name" value={name} onChange={(e)=>setName(e.target.value)} required />
            </InputBox>
