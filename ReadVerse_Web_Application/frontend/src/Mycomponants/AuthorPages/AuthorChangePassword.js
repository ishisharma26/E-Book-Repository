...
const AuthorChangePassword = () => {
  ...
  const HendleSubmit=(e)=>{
    ...
    axios.put(`http://localhost:5000/author/changePassword`,{currentPassword,newPassword})
    .then((result)=>{
  ...
  return (
    <div style={{display:"flex",justifyContent:"center" ,paddingTop:"15vh" ,backgroundColor:"gray",minHeight:"100vh"}} >
      ...
      <Title>Author Change Password</Title>
...
export default AuthorChangePassword;
