...
function Home() {
  return (
    <div>
            ...
            <div className="d-flex justify-content-between">
                <div className="top-info ps-2">
                    <small className="me-3 text-white">
                        ...
                        <a href="#" className="text-white">1** Street, ** New York</a>
                    </small>
                    <small className="me-3 text-white">
                        <i className="fas fa-envelope me-2 text-secondary"></i>
                        <a href="#" className="text-white">E**il@Example.com</a>
                    </small>
                </div>
        ...
        <a href="index.html" className="navbar-brand"><h1 className="text-primary display-6">ReadVerse</h1></a>
        ...
        <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
          <div className="navbar-nav mx-auto">
            ...
            <Link to="frontViewShops" className="nav-item nav-link">Shop</Link>
            <Link to="category" className="nav-item nav-link">Genre Category</Link>
          ...
          <div className="pb-4 mb-4" style={{ borderBottom: "1px solid rgba(226, 175, 24, 0.5)" }}>
            <div className="row g-4">
              <div className="col-lg-3">
                <a href="#">
                  <h1 className="text-primary mb-0">ReadVerse</h1>
                  <p className="text-secondary mb-0">Book Shop</p>
                </a>
              </div>
          ...
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <p className="mb-4">User-Friendly Design Quality Content  Personalization  Community Engagement  Responsive Customer Support Innovative Features  Accessibility  Social Proof and Reviews.</p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              <span className="text-light"><a href="#"><i className="fas fa-copyright text-light me-2"></i>ReadVerse</a>, All right reserved.</span>
            </div>
            <div className="col-md-6 my-auto text-center text-md-end text-white">
              {/* This template is free as long as you keep the below author’s credit link/attribution link/backlink. */}
              {/* If you'd like to use the template without the below author’s credit link/attribution link/backlink, */}
              {/* you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". */}
              Designed By <a className="border-bottom" href="/" > ReadVerse</a>
            </div>
          </div>
        </div>
         </div>
